...
The three major user oriented functions happen to be :func:`gamornet.keras_module.gamornet_predict_keras`, :func:`gamornet.keras_module.gamornet_train_keras` and :func:`gamornet.keras_module.gamornet_tl_keras`
